...
class EventParameterChangeOfTimer(Sequence):
    sequenceElements = \
        [ Element('timeDelay', Unsigned, 0)
        , Element('alarmValues', SequenceOf(TimerState), 1)
        , Element('updateTimeReference', DeviceObjectPropertyReference, 2)
        ]
...
class EventParameter(Choice):
    choiceElements = \
        ...
        , Element('changeOfDiscreteValue', EventParameterChangeOfDiscreteValue, 21)
        , Element('changeOfTimer', EventParameterChangeOfTimer, 22)
        ]
